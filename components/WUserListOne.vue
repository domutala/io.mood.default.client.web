          ...
          <div>
            <div>
              ...
              <div
                ...
                class="btns"
              >
                <button class="btn opac sm" @click="opener('update')">
                  <div>modifier</div>
                </button>
                <button class="btn opac sm" @click="opener('blocked')">
                  <div>
                    {{ user.value.data.blocked ? "Débloquer" : "Bloquer" }}
                  </div>
                </button>
                <button class="btn opac sm danger" @click="opener('remove')">
                  <div>supprimer</div>
                </button>
              </div>
            </div>
...
import { UserFormat } from "~/models/User";
